  ...
  const handleImageChange = (event) => {
	...
	return (
		<div className="flex flex-col justify-center items-center">
			<div className="text-center mb-4">
				<h1 className="text-1xl md:text-2xl md:px-10 font-bold mb-4 w-full text-white">
					Upload Foto Kenangan Kelas Disini
				</h1>
			</div>
						...
						<label
							...
							{imageUpload ? (
								...
								<div className="text-center px-5 py-8">
									...
									<p className="text-white opacity-60">Klik Disini</p>
								</div>
							)}
						</label>
					</div>
      ...
      <div className="text-white text-[0.7rem] mt-5">
								 Reload Halaman Jika Sudah Upload
							</div>
              <div className="text-white text-[0.7rem] mt-3">
								 Tekan Foto Untuk Mengunduh Foto
							</div>
