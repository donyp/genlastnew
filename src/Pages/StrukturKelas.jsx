			...
			<div className="flex flex-col justify-center items-center">
				...
				<div className="flex relative top-[-3rem]" data-aos="fade-up" data-aos-duration="1200">
					<div className="relative left-[0.2rem]">
						<BorderStruktur Jabatan="Ketua Kelas" Nama="Doni.S" Width="120px" />
					</div>
					...
					<div className="relative right-[0.2rem]">
						<BorderStruktur Jabatan="Wakil Ketua" Nama="Anggi.S" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Sekretaris" Nama="Anggitha.Z" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Nadya.S" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Bendahara" Nama="Salsabila" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Deaswa" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Keamanan" Nama="Arwani" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Dzakwan" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Kesehatan" Nama="Laudya.I" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Vina.N" Width="120px" />
					</div>

					<div className="flex-col hidden lg:flex">
						<BorderStruktur Jabatan="Kebersihan" Nama="Bayu.S" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Gabriella" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					data-aos-duration="1100">
					<div className="flex-col">
						<BorderStruktur Jabatan="Keagamaan" Nama="Rafi.D" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Jasmani" Nama="Dzaky.N" Width="120px" />
					</div>
				</div>
