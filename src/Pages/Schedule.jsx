...
const Schedule = () => {
    ...
    piketGroup = [
        ["Dzakwan", "Feli", "Fani", "Rara", "Arwan", "Salsa", "Vina"],
        ["Bakti", "Jihan", "Aninda", "Dzaky", "Dea", "Zalfa"],
        ["Mawar", "Dewi", "Kayla", "Rafi", "Niken", "Siti"],
        ["Arif", "Nadya", "Laudya", "Iksan", "Gaby", "Naura", "Dinda"],
        ["Faiz", "Adinda", "Saskia", "Lulu", "Bayu", "Nurul", "Indah", "Elma"],
    ]
